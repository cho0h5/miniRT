...
LDFLAGS	=	-Llibft -lft -lmlx -lm -framework OpenGL -framework Appkit
...
SRCS	=	$(SRC_DIR)main.c									\
			...
			$(SRC_DIR)environment_free.c						\
			$(SRC_DIR)equation_closest_point_on_skew_lines.c	\
			$(SRC_DIR)validate_environment.c					\
			$(SRC_DIR)validate_light.c							\
			$(SRC_DIR)validate_camera.c							\
			$(SRC_DIR)validate_ambient.c						\
			$(SRC_DIR)validate_object.c							\
