...
/*   Updated: 2024/08/29 13:10:52 by younghoc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_vector3	get_plane_ambient(const t_plane *plane, const t_ambient *ambient)
{
	return (multiply(plane->color, scale(ambient->color, ambient->ratio / 255)));
}
